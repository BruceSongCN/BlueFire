...
<!--
  ____   _      _    _  ______  ______  _____  _____   ______
 |  _ \ | |    | |  | ||  ____||  ____||_   _||  __ \ |  ____|
 | |_) || |    | |  | || |__   | |__     | |  | |__) || |__
 |  _ < | |    | |  | ||  __|  |  __|    | |  |  _  / |  __|
 | |_) || |____| |__| || |____ | |      _| |_ | | \ \ | |____
 |____/ |______|\____/ |______||_|     |_____||_|  \_\|______|

                                                 
    ASCII text from http://patorjk.com/software/taag/#p=display&h=1&v=0&f=Big&t=BLUEFIRE
    Template from https://almsaeedstudio.com/
    modified by BRUCE
-->
@stop

@section('title') 后台 - BluefireCMS @stop
    ...
    <div class="wrapper">
      ...
      <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
          后台模版基于 <a href="https://github.com/almasaeed2010/AdminLTE">AdminLTE</a> ， 经过修改以适配当前系统 。
        </div>
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016-{{ date('Y') }}  <a href="http://www.yascmf.com/">{{ trans('yascmf.full_name') }}</a></strong>
      </footer>
